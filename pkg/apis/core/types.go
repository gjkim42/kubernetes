...
type Container struct {
	...
	// By default, if no value is assigned to this field, the restart behavior of
	// the container follows the Pod's RestartPolicy. This field may only be set
	// for init containers and only allowed value is "Always".
	// "Always" results in this init container being continually restarted on
